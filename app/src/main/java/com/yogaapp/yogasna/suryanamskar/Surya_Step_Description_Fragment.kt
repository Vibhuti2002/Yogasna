...
class Surya_Step_Description_Fragment : Fragment() {
    ...
    val head = arrayOf("Step 1 (Prayer Pose)", "Step 2 (Raised Arms pose)","Step 3 (Hand to Foot pose)",
        "Step 4 (Equestrian pose)", "Step 5 (Stick pose)", "Step 6 (Saluting with eight points or parts)", "Step 7 (Cobra pose)",
        "Step 8 (Mountain pose)", "Step 9 (Equestrian pose)", "Step 10 (Hand to foot pose)","Step 11 (Raised Arms pose)", "Step 12")


    val stepdescription = arrayOf("Stand at the end of your mat, keep your feet together and distribute your weight on both feet equally. Open your chest and just relax your shoulders. Breathe in and lift both your arms up from the sides. Exhale and bring your palms together in a prayer position in front of your chest.",
...
//       binding..setOnClickListener{
        ...
        val storageRef = FirebaseStorage.getInstance().reference.child("SuryaNamaskarSteps/${stepimagename[args.pos]}.jpg")
